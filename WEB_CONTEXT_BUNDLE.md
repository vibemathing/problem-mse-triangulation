...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "mse-triangulation",
      "Triangulation of a polygon cash reward"
    ],
    "allowed_axioms": [
      "none"
    ],
    ...
    "problem_id": "problem:mse-triangulation",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "mse-triangulation",
    ...
    "statement": {
      "language": "en",
      "text": "Draft bounty intake target(s): Triangulation of a polygon cash reward. The exact mathematical statement, quantifiers, definitions, assumptions, and acceptance conditions have not yet been frozen; this draft is not research-admitted.",
      "version": 1
    },
    "title": "Triangulation of a polygon cash reward",
    "updated_at": "2026-09-08T08:24:29Z"
  },
  "problem_contract_sha256": "62e534913838ba87f6024763344dd46fa58cfe243d4fe32d77be24f3dc35a72d"
}
```
